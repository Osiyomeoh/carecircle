...
function Section({ eyebrow, title, lead, children }: {
  ...
  return (
    <section className="mx-auto w-full max-w-6xl px-6 py-20 md:px-10 md:py-28">
      <div className="text-[12px] uppercase tracking-[0.22em] text-muted">{eyebrow}</div>
      <h2 className="mt-4 max-w-3xl text-3xl font-semibold leading-[1.12] tracking-tight md:text-5xl">
        {title}
      </h2>
      {lead && <p className="mt-6 max-w-2xl text-[15px] leading-relaxed text-[#c3cad9] md:text-lg">{lead}</p>}
      {children}
    </section>
  );
}
...
function Evidence({ figure, of, source, href, mechanism }: {
  ...
  return (
    <div className="glass flex flex-col rounded-2xl p-6">
      ...
      <div className="mt-3 text-[15px] leading-relaxed text-[#c3cad9]">{of}</div>
      <a
        href={href} target="_blank" rel="noreferrer"
        className="mt-3 text-[12px] text-muted underline decoration-line underline-offset-4 transition hover:text-ink"
      >
        {source}
      </a>
      <div className="mt-5 border-t border-line pt-5 text-[14px] leading-relaxed text-ink">
        <span className="text-[11px] uppercase tracking-[0.14em] text-core">What CareCircle does</span>
...
function Step({ n, name, body }: { n: string; name: string; body: string }) {
  return (
    <div className="glass rounded-2xl p-6">
      <div className="text-[12px] tracking-[0.2em] text-muted">{n}</div>
      <div className="mt-3 text-lg font-semibold text-ink">{name}</div>
      <p className="mt-2 text-[14px] leading-relaxed text-[#c3cad9]">{body}</p>
    </div>
  );
}
  ...
  return (
    <div className="min-h-screen w-full bg-bg">
        ...
        <div className="relative z-10 flex h-full flex-col justify-between p-6 md:p-14">
          ...
          <div className="max-w-2xl animate-rise">
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              ...
              <a href="#problem" className="glass inline-flex items-center gap-2 rounded-xl px-5 py-3 text-[15px] font-medium text-ink transition hover:-translate-y-0.5">
                See how it works
              </a>
            </div>
          </div>
        ...
        >
          <div className="mt-12 grid items-stretch gap-5 lg:grid-cols-3">
            <div className="glass rounded-2xl p-7">
              <div className="text-[12px] uppercase tracking-[0.18em] text-muted">Raw Claude Sonnet 4.5</div>
              <div className="mt-4 text-6xl font-semibold tracking-tight text-sevHigh">50%</div>
              <p className="mt-4 text-[14px] leading-relaxed text-[#c3cad9]">
            ...
            <div className="glass rounded-2xl p-7">
              <div className="text-[12px] uppercase tracking-[0.18em] text-muted">CareCircle</div>
            ...
            <div className="glass flex flex-col rounded-2xl p-7">
              <div className="text-[12px] uppercase tracking-[0.18em] text-muted">Check it yourself</div>
              <p className="mt-4 text-[14px] leading-relaxed text-[#c3cad9]">
                Every answer in the benchmark is printed and auditable. It is a script in the repo,
                not a screenshot.
              </p>
              <code className="mt-auto block rounded-xl border border-line bg-black/40 px-4 py-3 font-mono text-[13px] text-core">
                npm run trust-benchmark
              </code>
            </div>
          </div>

          <p className="mt-8 max-w-3xl text-[14px] leading-relaxed text-muted">
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-2">
            <div className="glass rounded-2xl p-7">
              <div className="flex items-center gap-2.5">
                ...
                <span className="ml-auto rounded-md border border-line px-2 py-0.5 text-[10px] uppercase tracking-wider text-core">live</span>
              </div>
              <p className="mt-4 text-[14px] leading-relaxed text-[#c3cad9]">
            ...
            <div className="glass rounded-2xl p-7">
              <div className="flex items-center gap-2.5">
                ...
                <span className="ml-auto rounded-md border border-line px-2 py-0.5 text-[10px] uppercase tracking-wider text-muted">seam</span>
              </div>
              <p className="mt-4 text-[14px] leading-relaxed text-[#c3cad9]">
        ...
        >
          <div className="mt-12 grid gap-5 md:grid-cols-3">
            <div className="glass rounded-2xl p-6">
              ...
              <p className="mt-3 text-[14px] leading-relaxed text-[#c3cad9]">
      ...
      <div className="border-t border-line bg-[#0a0e18]">
        ...
        >
          <pre className="mt-10 max-w-xl overflow-x-auto rounded-xl border border-line bg-black/40 px-5 py-4 font-mono text-[13px] leading-relaxed text-core">
git clone https://github.com/Osiyomeoh/carecircle{'\n'}npm ci &amp;&amp; npm run story
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a href="https://github.com/Osiyomeoh/carecircle" target="_blank" rel="noreferrer"
              className="glass inline-flex items-center gap-2 rounded-xl px-5 py-3 text-[15px] font-medium text-ink transition hover:-translate-y-0.5">
              Read the source
            </a>
          </div>

          <div className="mt-16 border-t border-line pt-8 text-[13px] text-muted">
